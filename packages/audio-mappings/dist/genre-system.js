...
function generateKpopMelody(chartData, tempo, scales) {
    return {
        genre: 'kpop',
        tempo,
        scale: scales[0],
...
function generateLofiMelody(chartData, tempo, scales) {
    return {
        genre: 'lofi',
        tempo,
        scale: scales[0],
...
function generateOrchestralMelody(chartData, tempo, scales) {
    return {
        genre: 'orchestral',
        tempo,
        scale: scales[0],
...
function generateMinimalMelody(chartData, tempo, scales) {
    return {
        genre: 'minimal',
        tempo,
        scale: scales[0],
...
function generateTrapMelody(chartData, tempo, scales) {
    return {
        genre: 'trap',
        tempo,
        scale: scales[0],
...
function generateExperimentalMelody(chartData, tempo, scales) {
    return {
        genre: 'experimental',
        tempo,
        scale: scales[0],
