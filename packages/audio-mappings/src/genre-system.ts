...
export function getGenreConfig(genre: Genre): GenreConfig {
  return GENRE_CONFIGS[genre] || GENRE_CONFIGS.ambient;
}

export function getMoodMapping(mood: Mood): MoodToGenreMapping {
  return MOOD_TO_GENRE_MAPPINGS[mood] || MOOD_TO_GENRE_MAPPINGS.chill;
}

export function getRandomGenre(): Genre {
  const genres = Object.keys(GENRE_CONFIGS) as Genre[];
  return genres[Math.floor(Math.random() * genres.length)];
}

export function getGenreFromMood(mood: Mood): Genre {
  const mapping = getMoodMapping(mood);
  const genres = mapping.genres;
  return genres[Math.floor(Math.random() * genres.length)] as Genre;
}

export function getInstrumentsForGenre(genre: Genre): InstrumentMapping {
  const config = getGenreConfig(genre);
  return config.instruments;
}

export function getVisualStyleForGenre(genre: Genre): VisualStyle {
  const config = getGenreConfig(genre);
  return config.visuals;
}

export function getTextStyleForGenre(genre: Genre): TextStyle {
  const config = getGenreConfig(genre);
  return config.text;
}

export function getTempoForGenre(genre: Genre): { min: number; max: number; default: number } {
  const config = getGenreConfig(genre);
  return config.tempo;
}

export function getScalesForGenre(genre: Genre): string[] {
  const config = getGenreConfig(genre);
...
export function getAllMoods(): Mood[] {
  return Object.keys(MOOD_TO_GENRE_MAPPINGS) as Mood[];
}

// ===== GENRE-SPECIFIC AUDIO GENERATION =====

export function generateGenreSpecificMelody(genre: Genre, chartData: any): any {
  const config = getGenreConfig(genre);
...
function generateClassicalMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'classical',
    tempo,
    scale: scales[0],
...
function generateHouseMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'house',
    tempo,
    scale: scales[0],
...
function generateTechnoMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'techno',
    tempo,
    scale: scales[0],
...
function generateJazzMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'jazz',
    tempo,
    scale: scales[0],
...
function generatePopMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'pop',
    tempo,
    scale: scales[0],
...
function generateBluesMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'blues',
    tempo,
    scale: scales[0],
...
function generateFolkMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'folk',
    tempo,
    scale: scales[0],
...
function generateAmbientMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'ambient',
    tempo,
    scale: scales[0],
...
function generateSynthwaveMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'synthwave',
    tempo,
    scale: scales[0],
...
function generateWorldFusionMelody(chartData: any, tempo: number, scales: string[]): any {
  return {
    genre: 'world_fusion',
    tempo,
    scale: scales[0],
...
function generateHouseNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for house note generation
  return [];
}

function generateTechnoNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for techno note generation
  return [];
}

function generateJazzNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for jazz note generation
  return [];
}

function generatePopNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for pop note generation
  return [];
}

function generateBluesNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for blues note generation
  return [];
}

function generateFolkNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for folk note generation
  return [];
}

function generateAmbientNotes(chartData: any, tempo: number, scale: string): any[] {
  // Implementation for ambient note generation
  return [];
}

function generateSynthwaveNotes(chartData: any, tempo: number, scale: string): any[] {
