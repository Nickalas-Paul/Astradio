...
class SwissEphemerisService {
    constructor() {
        ...
        try {
            ...
            const ephePath = path_1.default.resolve(process.cwd(), 'temp-swisseph');
    ...
    async calculateHouseCusps(date, latitude, longitude, timezone) {
        if (this.mode === 'fallback') {
            return { cusps: [], ascmc: [] };
        }
        try {
    ...
    convertToAstroChart(planets, houses, aspects, metadata) {
        return {
            planets,
            houses,
            aspects,
...
exports.default = SwissEphemerisService;
//# sourceMappingURL=swissEphemerisService.js.map