...
-- Insert default daily chart for today
INSERT OR IGNORE INTO daily_charts (id, date, chart_data, narration, audio_config) 
VALUES (
    'daily_' || date('now'),
    date('now'),
    '{"metadata":{"birth_datetime":"2024-01-01T12:00:00Z"},"planets":{}}',
    '{"musicalMood":"Today''s cosmic energy invites reflection and growth","planetaryExpression":"The planets align for creative expression","interpretiveSummary":"A day of musical discovery awaits"}',
